...
export default function CreateSubAgent() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      setLoading(true);
      await AgentService.createSubAgent(form);
      alert("Sub-agente criado com sucesso.");
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-0.5">
              Integre um novo funcionário na sua equipa
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div className="flex justify-end pt-4 border-t border-white/[0.03]">
          ...
          >
            ...
            {loading ? "A guardar..." : "Criar Sub-agente"}
          </button>
        </div>
      </form>
    </div>
