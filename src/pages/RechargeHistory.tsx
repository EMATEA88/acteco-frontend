    ...
    <div className="min-h-screen bg-[#0B0E11] text-white">
      ...
      <div className="sticky top-0 z-20 bg-[#0B0E11]/80 backdrop-blur-xl border-b border-white/5 px-5 py-6">
        <div className="flex items-center gap-4">
          <button 
            onClick={() => navigate(-1)} 
            className="p-2.5 bg-white/5 hover:bg-white/10 rounded-full border border-white/5"
          >
          ...
          <div className="space-y-3">
            {items.map((item) => {
              ...
              return (
                <div 
                  key={item.id} 
                  className="bg-[#161A1E] border border-white/5 rounded-2xl p-4 flex items-center gap-4"
                >
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div>
                        <p className={`text-sm font-bold ${
                          isCrypto ? 'text-white' : 'text-emerald-500'
                        }`}>
