          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-[#0e364a]/60 border border-cyan-500/15 p-4 rounded-xl flex items-start gap-3 transition-all duration-300 hover:border-cyan-400/40 hover:bg-[#0e364a] shadow-lg shadow-cyan-950/20"
                >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full p-3.5 rounded-xl bg-[#0e364a] border border-cyan-500/20 focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 text-sm font-mono text-white transition-all duration-200 placeholder:text-cyan-200/30 focus:outline-none"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-cyan-600 hover:bg-cyan-500 disabled:opacity-50 text-white p-3.5 rounded-xl font-bold font-mono text-xs uppercase tracking-wider transition-all duration-200 flex items-center justify-center gap-2 mt-2 shadow-lg shadow-cyan-950/30 hover:shadow-cyan-950/50 active:scale-[0.98] cursor-pointer"
            >
              {loading ? (
            ...
            <div className="flex justify-end pt-1">
              <button
                ...
                className="text-xs text-cyan-300 hover:text-cyan-200 font-medium font-mono transition-colors cursor-pointer"
              >
          ...
          <div className="space-y-4 text-center font-mono">
            <p className="text-xs text-cyan-200/70">
              ...
              <span
                ...
                className="text-cyan-400 hover:text-cyan-300 cursor-pointer font-semibold underline underline-offset-4"
              >
